...
import it.greengers.potnetcore.core.MasterContext
...
object PotNetCoreCoreCoreController {
    ...
    val CONTROLLER_SCOPE = CoroutineScope(EmptyCoroutineContext + CoroutineName(this::class.java.name))

    val SERVER_NAME = "main-server"
    var SERVER_CONNECTION : PotConnection private set
    val CONNECTION_MUTEX = Mutex()
    var RECONNECTOR : Reconnector private set
    val ON_MESSAGE = this::onMessage
    val MUTEX = Mutex()

    val TERMINATE_CHANNEL = Channel<Unit>()
        ...
        Runtime.getRuntime().addShutdownHook(
            thread {
                ...
                runBlocking {
                    ...
                    MasterContext.SCOPE.cancel("Shutdown Hook")
